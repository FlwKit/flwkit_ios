...
class BlockRendererRegistry {
    ...
    private func registerDefaultRenderers() {
        ...
        register("image", renderer: MediaBlockRenderer())
        register("video", renderer: MediaBlockRenderer())
        register("media_block", renderer: MediaBlockRenderer())
        register("image_block", renderer: MediaBlockRenderer())
        register("video_block", renderer: MediaBlockRenderer())
